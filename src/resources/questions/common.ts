...
// for content-bearing elements that may be filled in with dummy empty paragraph
// arg is containing parent that may have array of of content elements as children
export const emptyOrDummyContent = (c: any) =>
